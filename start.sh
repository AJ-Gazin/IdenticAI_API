...
mkdir -p /workspace/ComfyUI /ComfyUI/output
chown -R 1000:1000 /workspace /ComfyUI/output
chmod 755 /workspace /ComfyUI/output

# --- Initialize ComfyUI ---
echo "Setting up ComfyUI workspace..."
sed -i 's/mv /cp -r /g' ./scripts/comfyui-on-workspace.sh  # Prevent moving busy directories
